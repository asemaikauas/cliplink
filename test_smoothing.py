...
def test_smoothing_levels(video_path: str):
    ...
    try:
        ...
        smoothing_levels = {
            ...
            "very_high": "Экстремальное сглаживание (максимально плавно)"
        }
        ...
        print(f"📊 Создано файлов: {len(results)}/{len(smoothing_levels)}")
        ...
        if results:
            ...
            print(f"   • VERY_HIGH = Для максимальной стабильности (самый плавный)")
